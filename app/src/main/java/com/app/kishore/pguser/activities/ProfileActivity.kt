        ...
        dndSwitch.setOnClickListener(object : View.OnClickListener {
            override fun onClick(p0: View?) {
                if(dndSwitch.isChecked){
                    Toast.makeText(this@ProfileActivity, "Select date of return", Toast.LENGTH_LONG).show()
            ...
            val request = VolleyRequest(this, object :
                ...
                override fun errorCallback(error_message: VolleyError) {
                    ...
                    if (networkResponse != null && networkResponse.data != null) {
                        ...
                        try {
                            Toast.makeText(this@ProfileActivity, errorJson.getString("error"), Toast.LENGTH_SHORT).show()

                        }catch (e : Exception){
                            Toast.makeText(this@ProfileActivity, errorJson.getString("An error occurred!Please try again later."), Toast.LENGTH_SHORT).show()
                        }
                    }
                }
        ...
        val request = VolleyRequest(this, object :
            ...
            override fun responseCallback(response: JSONObject) {
               val status = response.get("dnd") as Boolean
                ...
                if (status)
                Toast.makeText(this@ProfileActivity, "DND turned ON!", Toast.LENGTH_SHORT).show()
                else Toast.makeText(this@ProfileActivity, "DND turned OFF!", Toast.LENGTH_SHORT).show()
            loading.cancel()
            }
